...
public interface IGlamourService extends Remote {
    ...
    SalonService updateService(SalonService s) throws RemoteException;
    void deleteService(Integer id) throws RemoteException;

    List<Staff> getStaff() throws RemoteException;
    Staff saveStaff(Staff s) throws RemoteException;
    Staff updateStaff(Staff s) throws RemoteException;
    void deleteStaff(Integer id) throws RemoteException;
